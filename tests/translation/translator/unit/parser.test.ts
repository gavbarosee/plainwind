...
import {
  ...
  extractImportant,
  extractPrefix,
} from '@src/core/translation/engine/parser';
import {
  PARSE_SPLIT_CASES,
...
describe('extractVariants', () => {
  ...
  describe('complex bracket handling', () => {
    it.each(COMPLEX_VARIANT_EXTRACTION_CASES)(
      '%s extracts variants: %s, baseClass: %s',
      (input, expectedVariants, expectedBase) => {
...
describe('extractOpacity', () => {
  it.each(OPACITY_EXTRACTION_EDGE_CASES)(
    '%s -> className: %s, opacity: %s',
    (input, expectedClass, expectedOpacity) => {
...
describe('extractImportant', () => {
  ...
  describe('edge cases', () => {
    it.each(IMPORTANT_EXTRACTION_EDGE_CASES)(
      '%s -> className: %s, isImportant: %s',
      (input, expectedClass, expectedImportant) => {
...
describe('extractPrefix', () => {
  ...
  describe('edge cases', () => {
    it.each(PREFIX_EXTRACTION_EDGE_CASES)(
      '%s -> className: %s, prefix: %s',
      (input, expectedClass, expectedPrefix) => {
