...
export const interactivityMappings: Record<string, string> = {
  ...
  'snap-proximity': 'snaps when close to snap point',
  // Scroll Snap Align
  ...
  'will-change-scroll': 'optimizes for scrolling',
  'will-change-contents': 'optimizes for content changes',
  'will-change-transform': 'optimizes for transforms',
  // Appearance
  ...
  // Color Scheme (v4)
  'color-scheme-normal': 'no color scheme preference',
  'color-scheme-light': 'light color scheme',
  'color-scheme-dark': 'dark color scheme',
  'color-scheme-light-dark': 'supports both light and dark schemes',
  'scheme-normal': 'no color scheme preference',
  'scheme-light': 'light color scheme',
  'scheme-dark': 'dark color scheme',
  'scheme-light-dark': 'supports both light and dark schemes',
  ...
  'accent-inherit': 'inherited accent color',
  ...
  'caret-inherit': 'inherited caret color',
