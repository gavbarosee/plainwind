...
export const flexboxGridMappings: Record<string, string> = {
  ...
  'flex-initial': 'sized based on content (can shrink)',
  ...
  'justify-end-safe': 'aligns items to end (prevents overflow data loss)',
  'justify-center': 'centers items along main axis',
  'justify-center-safe': 'centers items (prevents overflow data loss)',
  ...
  'justify-self-center-safe': 'centers self (prevents overflow data loss)',
  'justify-self-end': 'aligns self to end',
  'justify-self-end-safe': 'aligns self to end (prevents overflow data loss)',
  ...
  'self-end-safe': 'aligns self to end (prevents overflow data loss)',
  'self-center': 'centers self',
  'self-center-safe': 'centers self (prevents overflow data loss)',
