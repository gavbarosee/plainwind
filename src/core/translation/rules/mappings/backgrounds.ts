...
export const backgroundsMappings: Record<string, string> = {
  ...
  'bg-scroll': 'background scrolls with viewport',
  // Background Clip
  'bg-clip-border': 'background extends through border area',
  'bg-clip-padding': 'background extends through padding area',
  'bg-clip-content': 'background only shows within content area',
  'bg-clip-text':
    'background shows only within text (text becomes transparent)',
  // Background Origin
  ...
  // Background Size
  'bg-auto': 'background image at original size',
  ...
  'from-current': 'gradient starts with text color',
  ...
  'via-current': 'gradient middle is text color',
  ...
  'to-current': 'gradient ends with text color',
  ...
  'bg-blend-normal': 'normal blend mode for background',
  'bg-blend-multiply': 'multiply blend mode for background',
  'bg-blend-screen': 'screen blend mode for background',
  'bg-blend-overlay': 'overlay blend mode for background',
  'bg-blend-darken': 'darken blend mode for background',
  'bg-blend-lighten': 'lighten blend mode for background',
  'bg-blend-color-dodge': 'color dodge blend mode for background',
  'bg-blend-color-burn': 'color burn blend mode for background',
  'bg-blend-hard-light': 'hard light blend mode for background',
  'bg-blend-soft-light': 'soft light blend mode for background',
  'bg-blend-difference': 'difference blend mode for background',
  'bg-blend-exclusion': 'exclusion blend mode for background',
  'bg-blend-hue': 'hue blend mode for background',
  'bg-blend-saturation': 'saturation blend mode for background',
  'bg-blend-color': 'color blend mode for background',
  'bg-blend-luminosity': 'luminosity blend mode for background',
};
